                ...
                children: [
                  Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(widget.restaurantItem.name,
                    ...
                    child: Row(
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(widget.restaurantItem.city,
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Container(
                            margin: EdgeInsets.only(left: 10),
                            child: Text(widget.restaurantItem.address,
                                style: detailRestaurantSubtitleStyle)),
                      ],
                    ),
                  ),
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Container(
                            margin: EdgeInsets.only(left: 10),
                            child: Text(widget.restaurantItem.rating.toString(),
                                style: detailRestaurantSubtitleStyle)),
                      ],
                    ),
                  ),
                  Container(
                    ...
                    child: Wrap(
                      ...
                      spacing: 8.0,
                      runSpacing: 8.0,
                      children: widget.restaurantItem.categories.map((category) {
                          return Container(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  for(var food in widget.restaurantItem.foodMenus)
                                    Padding(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  for(var drink in widget.restaurantItem.drinkMenus)
                                    Padding(
                                      padding: const EdgeInsets.only(top: 5, bottom: 5, right: 5),
                                      child: Row(
                                        children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(widget.restaurantItem.description,
                              style: TextStyle(
                                  fontSize: 18,
                                  height: 1.7,
                                  fontFamily: 'OpenSans',
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Column(
                          children: widget.restaurantItem.customerReviews.map((customerReview) {
                            return Container(
                              margin: const EdgeInsets.only(top: 10),
                              padding: const EdgeInsets.all(20),
                              decoration: BoxDecoration(
